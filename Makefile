...
CTC_BEAM_SEARCH_SRCS = $(wildcard tensorflow_ctc_beam_search_decoder/cc/kernels/*.cc) $(wildcard tensorflow_ctc_beam_search_decoder/cc/kernels/*.h) $(wildcard tensorflow_ctc_beam_search_decoder/cc/ops/*.cc)
...
CTC_BEAM_SEARCH_TARGET_LIB = tensorflow_ctc_beam_search_decoder/python/ops/_ctc_beam_search_decoder_ops.so
...
# ctc_beam_search_decoder op for CPU
ctc_beam_search_decoder_op: $(CTC_BEAM_SEARCH_TARGET_LIB)

$(CTC_BEAM_SEARCH_TARGET_LIB): $(CTC_BEAM_SEARCH_SRCS)
	$(CXX) $(CFLAGS) -o $@ $^ ${LDFLAGS}

ctc_beam_search_decoder_test: tensorflow_ctc_beam_search_decoder/python/ops/ctc_beam_search_decoder_ops_test.py tensorflow_ctc_beam_search_decoder/python/ops/ctc_beam_search_decoder_ops.py $(CTC_BEAM_SEARCH_TARGET_LIB)
	$(PYTHON_BIN_PATH) tensorflow_ctc_beam_search_decoder/python/ops/ctc_beam_search_decoder_ops_test.py

ctc_beam_search_decoder_pip_pkg: $(CTC_BEAM_SEARCH_TARGET_LIB)
	./build_pip_pkg.sh make artifacts
